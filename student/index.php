...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="form-inline my-2 my-lg-0" action="student_register.php">
                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#signupModal">
                    Sign Up
                </button>
            </form>
            <form class="form-inline my-2 my-lg-0 mx-4" action="student_login.php">
                ...
                <div class="modal-body">
                    <div class="container">
                        ...
                        <form action="student_register.php" method="post">
                            ...
                            <div class="form-group">
                                <label for="gphone">Guardien's Mobile No</label>
                                <input type="text" class="form-control" id="gphone" name="gphone" required>
                            </div>
                            <div class="form-group">
                                <label>Gender</label>
                                <div>
